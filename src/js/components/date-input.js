...
export default class DateInput extends React.Component {
	constructor(props) {
		super(props);
		// Call parse date on the initial value, so we can display the date the user input field is resolving to right from the first time the date is displayed
	...
	getOnBlur = () => {
		return (evt) => {
			// Need to call update here. The function to update needs to come through the props. For an example of this working, check the pairbondrel-lineitem-edit component.
