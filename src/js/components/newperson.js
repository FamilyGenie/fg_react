...
export default class NewPerson extends React.Component {
  ...
  render = () => {
    ...
    // const { events, eventTypes, parentalRel, parents, peopleArray, parentalRelTypes, parentalRelSubTypes, person, modalIsOpen  } = this.props;
    ...
    console.log("inside render", this.props);
      ...
      <div>
        ...
        <div class="modalH">
            New Person sadfkjad;klfjalsdkjfaslkdjfasldkj
        </div>
